...
public class Constants {
	...
	public enum StateGUI { ROBOT_TITLE,STATE_TITLE, STATE_GENERATING, STATE_PLAY, STATE_FINISH,STATE_LOSE; }
	// fixing a value matching the escape key
	final static int ESCAPE = 27;


	public static final int STATE_TITLE = 1; // title screen is on display
	public static final int STATE_GENERATING = 2; // generating screen with progress indication is on display

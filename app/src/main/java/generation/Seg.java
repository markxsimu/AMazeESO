...
public class Seg {
    ...
    private void initColor(final int distance, final int cc) {
        ...
        switch (((d >> 3) ^ cc) % 6) {
        case 0:
        		int[] colorToSet = {rgbValue, RGB_DEF, RGB_DEF};
            setColor(colorToSet);
            break;
        case 1:
        		int[] colorToSet1 = {RGB_DEF, rgbValue, RGB_DEF};
            setColor(colorToSet1);
            break;
        case 2:
        		int[] colorToSet2 = {RGB_DEF, RGB_DEF, rgbValue};
            setColor(colorToSet2);
            break;
        case 3:
        		int[] colorToSet3 = {rgbValue, rgbValue, RGB_DEF};
            setColor(colorToSet3);
            break;
        case 4:
        		int[] colorToSet4 = {RGB_DEF, rgbValue, rgbValue};
            setColor(colorToSet4);
            break;
        case 5:
        		int[] colorToSet5 = {rgbValue, RGB_DEF, rgbValue};
            setColor(colorToSet5);
            break;
        default:
        		int[] colorToSet6 = {RGB_DEF, RGB_DEF, RGB_DEF};
            setColor(colorToSet6);
            break;
        }
    }
    /**
    ...
    public boolean equals(final Object other) {
        ...
        if ((dist != o.dist) || (partition != o.partition) || (seen != o.seen)
               // || (col.getRGB() != o.col.getRGB())) {
        		|| (MazePanel.mazeGetRGB(getColor())) != MazePanel.mazeGetRGB(o.getColor())) {
            return false;
        }
